...
function AmericanKGCalendar() {
    ...
    return (
        <>
            <title>Harvest International School | American KG School Calendar</title>
            <meta name="description" content="Learn more about the American Kindergarten academic year calendar at Harvest International School in Borg El Arab, Egypt."/>
            ...
            <CalendarTable calendarId={"american-kg"}
                           title={t("events-pages.kg-calendars-pages.american-kg-calendar.title")}
