...
import {submitUpdateEventBookingExtrasRequest} from "../../../services/Parents/EventBookings/MainParentsEventBookingServices.jsx";
...
function EventBookingExtras() {
    ...
    useEffect(() => {
        headToEventBookingLoginOnInvalidSession(navigate, setIsLoading).then(
            () => {
        ...
        if (detailedData.extras) {
            ...
            if (detailedData.extras.additional_attendees >= 0) {
                currentFormFields.push({
                    ...
                    displayLabel: t("events-pages.event-booking-pages.booking-extras-page.extra-additional-attendees", {"cost-per-attendee": additionalAttendeeCost}),
                    required: false,
            ...
            if (detailedData.extras.additional_attendees >= 0) {
                currentFormFields.push({
                    ...
                    displayLabel: t("events-pages.event-booking-pages.booking-extras-page.extra-additional-attendees-cost"),
                    required: false,
            ...
            if (detailedData.extras.cd_count >= 0) {
                currentFormFields.push({
                    ...
                    displayLabel: t("events-pages.event-booking-pages.booking-extras-page.extra-cd-count", {"cost-per-cd": cdCost}),
                    required: false,
            ...
            if (detailedData.extras.cd_count >= 0) {
                currentFormFields.push({
                    ...
                    displayLabel: t("events-pages.event-booking-pages.booking-extras-page.extra-cd-count-cost"),
                    required: false,
            ...
            if (detailedData.extras.payment_status) {
                ...
                currentFormFields.push({
                    ...
                    displayLabel: t("events-pages.event-booking-pages.booking-extras-page.extra-payment-status"),
                    required: false,
            ...
            if (detailedData.extras) {
                currentFormFields.push({
                    ...
                    label: 'Total Cost:',
                    displayLabel: t("events-pages.event-booking-pages.booking-extras-page.extra-total-cost"),
                    required: false,
    ...
    const handleExtrasFormSubmit = async (formData) => {
        try {
            if (detailedData.booking && detailedData.booking.booking_id) {
                ...
                const result = await submitUpdateEventBookingExtrasRequest(formData, detailedData.booking.booking_id, navigate);
                ...
                if (result.success) {
                    ...
                    throw new Error(result.message || result || t("events-pages.event-booking-pages.booking-extras-page.error-while-submitting-the-form"));
                }
            } else {
                throw new Error(t("events-pages.event-booking-pages.booking-extras-page.booking-id-is-not-available"));
            }
        } catch (error) {
                                               ...
                                               <>
                                                   {
                                                       fetchBookingBySessionError ? (
                                                           ...
                                                           <div className={'booking-extras-form-wrapper'}>
                                                               <h3>
                                                                   {t("events-pages.event-booking-pages.booking-extras-page.title")}
                                                               </h3>
                                                               { extrasFormField && extrasFormField.length > 0 &&
                                                                   (
                                                                       <>
                                                                           <Form fields={ extrasFormField }
                                                                                 formTitle={ t("events-pages.event-booking-pages.booking-extras-page.title") }
                                                                                 mailTo={ '' }
                                                                                 noCaptcha={ true }
                                                                                 ...
                                                                                 differentSubmitButtonText={[
                                                                                     t("events-pages.event-booking-pages.booking-extras-page.save-btn"), t("events-pages.event-booking-pages.booking-extras-page.saving-btn")
                                                                                 ]}
                                                                           ...
                                                                           {formAllowEdit && (
                                                                               ( formReadOnly ? (
                                                                                       <button className={'booking-extras-edit-form-button'} onClick={ () => {setFormReadOnly( false );}}>
                                                                                           {t("events-pages.event-booking-pages.booking-extras-page.edit-btn")}
                                                                                       </button>
                                                                                   ) : (
                                                                                       <button className={'booking-extras-cancel-form-button'} onClick={ () => {
                                                                                           ...
                                                                                           {t("events-pages.event-booking-pages.booking-extras-page.cancel-btn")}
                                                                                       </button>
                                                                                   )
                                                                               )
                                                                           )}
...
export default EventBookingExtras;
