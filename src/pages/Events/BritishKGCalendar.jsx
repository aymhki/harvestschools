...
function BritishKGCalendar() {
    ...
    const calendarTableData = t("events-pages.kg-calendars-pages.british-kg-calendar.calendar", { returnObjects: true }) || [];
    ...
    return (
        <div className={"events-calendar-page"}>
            <Helmet>
                <title>Harvest International School | British KG Calendar</title>
                <meta name="description" content="Learn more about the British KG academic year calendar at Harvest International School in Borg El Arab, Egypt."/>
            ...
            <div className={"extreme-padding-container"}>
                ...
                <div className={"download-calendar-button-wrapper"} onClick={() => {
                    window.open("/assets/documents/Calendars/british_kg_calendar_2026.pdf", "_blank");
                }}>
