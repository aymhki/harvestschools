...
function NationalKGCalendar() {
    ...
    const calendarTableData = t("events-pages.kg-calendars-pages.national-kg-calendar.calendar", { returnObjects: true }) || [];
    ...
    return (
        <div className={"events-calendar-page"}>
            <Helmet>
                <title>Harvest International School | National KG Calendar</title>
                <meta name="description" content="Learn more about the National KG academic year calendar at Harvest International School in Borg El Arab, Egypt."/>
            ...
            <div className={"extreme-padding-container"}>
                <h1>
                    {t("events-pages.kg-calendars-pages.national-kg-calendar.title")}
                </h1>

                <Table tableData={finalTableData} numCols={3}/>

                <div className={"download-calendar-button-wrapper"} onClick={() => {
                    window.open(servePublicAsset("/documents/Calendars/national_kg_calendar_2026.pdf", {download:true}), "_blank");
                }}>
