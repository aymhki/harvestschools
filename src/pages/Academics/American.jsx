...
function American() {
  return (
      <div className={"american-academics-page"}>
          <ParallaxScrollSection backgroundImage={"../../assets/images/AcademicsPages/AmericanAcademicsPageHeader.png"}
          ...
          <ParallaxScrollSection
              backgroundImage={"../../assets/images/AcademicsPages/AmericanAcademicsPageMiddle1.png"}/>
          ...
          <ParallaxScrollSection backgroundImage={"../../assets/images/AcademicsPages/AmericanAcademicsPageMiddle2.png"}/>
            ...
            <ParallaxScrollSection backgroundImage={"../../assets/images/AcademicsPages/AmericanAcademicsPageFooter.png"} text={"- Ms. Salma Ehab, American School Principal"} darken={true} image={"../../assets/images/AcademicsPages/ClosingQuote.png"} imageAlt={"American Academics Page Footer Closing Quote"}/>
