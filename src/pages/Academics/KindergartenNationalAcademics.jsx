...
function KindergartenNationalAcademics() {
    const { t } = useTranslation(['academics-pages']);

    return (
        <div className={"kindergarten-academics-page"}>
            <Helmet>
                <title>Harvest International School | National KG Academics</title>
            ...
            <ParallaxScrollSection
                backgroundImage={servePublicAsset("/images/AcademicsPages/NationalKindergartenAcademicsPageHeader1.jpg")}
                darken={true}
            ...
            <div className={"standard-padding-container"}>
                <p>
                    {t("academics-pages.kindergarten.national-kindergarten-intro-paragraph")}
                </p>
                <p>
                    {t("academics-pages.kindergarten.national-kindergarten-vision-paragraph")}
                </p>
            </div>

            <ParallaxScrollSection backgroundImage={servePublicAsset("/images/AcademicsPages/NationalKindergartenAcademicsPageMiddle1.jpg")}/>

            <div className={"standard-padding-container"}>
                <p>
                    {t("academics-pages.kindergarten.national-kindergarten-team-paragraph")}
                </p>
                <p>
                    {t("academics-pages.kindergarten.national-kindergarten-outro-paragraph")}
                </p>
            </div>

            <ParallaxScrollSection
                backgroundImage={servePublicAsset("/images/AcademicsPages/NationalKindergartenAcademicsPageFooter1.jpg")}
                darken={true}
...
export default KindergartenNationalAcademics;