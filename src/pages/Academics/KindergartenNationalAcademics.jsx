    ...
    return (
        <div className={"kindergarten-academics-page"}>
            ...
            <ParallaxScrollSection
                backgroundImage={"../../assets/images/AcademicsPages/NationalKindergartenAcademicsPageHeader1.jpg"}
                darken={true}
            ...
            <ParallaxScrollSection backgroundImage={"../../assets/images/AcademicsPages/NationalKindergartenAcademicsPageMiddle1.jpg"}/>
            ...
            <ParallaxScrollSection
                backgroundImage={"../../assets/images/AcademicsPages/NationalKindergartenAcademicsPageFooter1.jpg"}
                darken={true}
