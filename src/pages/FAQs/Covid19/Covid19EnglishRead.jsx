  ...
  return (
    <div className={"covid-19-english-read-page"}>
      <container className={"extreme-padding-container"}>
          ...
          <p className={"covid-19-english-read-paragraph"}>
          ...
          <h2 className={"covid-19-english-read-title"}>
            ...
            <ul className={"covid-19-english-read-numbered-list"}>
                <li>
                    <p>
                        Make sure to inform your children about the Covid-19 virus, so they realize that feeling anxious or nervous about going back to school is a natural matter.
                    </p>
                </li>

                <li>
                    <p>
                        Make sure to engage in conversation with them about their fears and worries of returning to school. Explain to them the cautionary measurements that Harvest schools will follow to assure everyone’s safety.
                    </p>
                </li>

                <li>
                    <p>
                        Make sure to clarify the changes that will occur inside the school with great respect to the role they will have to follow in order to maintain the safety of their own and their community. And we recommend wearing face masks, social distancing, and constantly washing hands.
                    </p>
                </li>

                <li>
                    <p>
                        Remember to show the positive side of returning to school that includes meeting friends and learning new topics as done recently in many countries around the world.
                    </p>
                </li>

                <li>
                    <p>
                        Make sure to constantly engage in conversation with them about how are they feeling and what do they require before going. Back to school.
                    </p>
                </li>
            </ul>
          ...
          <p>
                <strong>What should parents know?</strong>
          </p>

            <ul className={"covid-19-english-read-list"}>
                <li>
                    <p>
                ...
                <li>
                    <p>
                        The school will provide a 100% remote learning option that the students could follow if one of
                    ...
                    <ul className={"covid-19-english-read-list"}>
                        <li>
                            <p>
                                If the student is suffering from a severe medical condition, Then, for the student’s own
                                safety, it is recommended that he/she stay at home while using the remote learning
                                option. However, the parents will be obligated to provide a medical report regarding the
                                student’s condition. Kindly contact the school for more details.
                            </p>
                        </li>

                        <li>
                            <p>
                                If parents wish to not send their son/daughter to the school and prefer him/her staying
                                at home during the first academic semester. In this case, the parents will have to
                                contact the school to sign the approval form.
                            </p>
                        </li>
                    </ul>
          ...
          <ul className={"covid-19-english-read-list"}>
              <li>
                  <p>
                      All students enrolled in the academic year of 2021/2022 must commit to attending the school
                      (either physically or through virtual classes while completing the remote educational tasks) and
                      completing all educational tasks according to the plan admitted by the school.
                  </p>
              </li>

              <li>
                  <p>
                      In case a student repeats his/her absence to the school premises, virtual classes, or remote
                      educational tasks, The school will take the necessary measures presented in the absence/attendance policy.
                    </p>
                </li>
            </ul>
          ...
          <h2 className={"covid-19-english-read-title"}>
            ...
            <ul className={"covid-19-english-read-list"}>
                ...
                <li>
                    <p>
                        Students that would find difficulties in social distancing will be distributed into small groups in the kindergarten stage.
                    </p>
                </li>
          ...
          <h2 className={"covid-19-english-read-title"}>
            ...
            <ul className={"covid-19-english-read-list"}>
                ...
                <li>
                    <p>
                        Parents must wear a face mask when delivering the student to the school.
                    </p>
                </li>
          ...
          <p>
              To receive the newest updates about Covid-19 from official government organizations,visit:

              <div onClick={() => window.open('https://www.care.gov.eg/EgyptCare/Index.aspx', '_blank')}
                   className={"covid-19-english-read-link"}>
          ...
          <p>
              For more information about applying to Harvest Schools, visit

              <div onClick={() => window.open('https://harvestschools.com', '_blank')} className={"covid-19-english-read-link"}>
                https://www.harvestschools.com
              </div>
...
export default Covid19EnglishRead;