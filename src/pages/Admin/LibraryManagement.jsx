...
function LibraryManagement() {
    ...
    const buildFormFields = (categoryKey, rowData) => ([
        { id: categoryFieldId, type: 'select', name: 'category', label: 'Category', required: true, choices: categoryChoices, defaultValue: choiceForCategoryKey(categoryKey), value: choiceForCategoryKey(categoryKey), widthOfField: 2, labelOutside: true, labelOnTop: true, displayLabel: 'Category', httpName: 'library-category' },
        { id: isPublicFieldId, type: 'select', name: 'is_public', label: 'Shown Publicly', required: true, choices: ['Yes', 'No'], defaultValue: rowData ? rowData[isPublicColIndex] : 'Yes', value: rowData ? rowData[isPublicColIndex] : 'Yes', widthOfField: 2, labelOutside: true, labelOnTop: true, displayLabel: 'Shown Publicly', httpName: 'library-is-public' },
        { id: titleEnFieldId, type: 'text', name: 'title_en', label: 'Title (EN)', required: true, errorMsg: 'Please enter the English title', value: rowData ? rowData[titleEnColIndex] : '', widthOfField: 2, labelOutside: true, labelOnTop: true, displayLabel: 'Title (EN)', httpName: 'library-title-en' },
        { id: titleArFieldId, type: 'text', name: 'title_ar', label: 'Title (AR)', required: true, errorMsg: 'Please enter the Arabic title', value: rowData ? rowData[titleArColIndex] : '', widthOfField: 2, labelOutside: true, labelOnTop: true, displayLabel: 'Title (AR)', lang: 'ar', httpName: 'library-title-ar' },
        { id: seriesEnFieldId, type: 'text', name: 'series_en', label: 'Series (EN)', required: false, value: rowData ? rowData[seriesEnColIndex] : '', widthOfField: 2, labelOutside: true, labelOnTop: true, displayLabel: 'Series or Distributor (EN)', httpName: 'library-series-en' },
        { id: seriesArFieldId, type: 'text', name: 'series_ar', label: 'Series (AR)', required: false, value: rowData ? rowData[seriesArColIndex] : '', widthOfField: 2, labelOutside: true, labelOnTop: true, displayLabel: 'Series or Distributor (AR)', lang: 'ar', httpName: 'library-series-ar' },
    ]);
