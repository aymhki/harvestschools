      ...
      <div className="admission-outside-egypt-foreigners-page">
          <Helmet>
              ...
              <meta name="description"
                    content="Learn more about what is required from parents and students when applying to transfer from a school as a foreigner or applying to schools for the first time as a foreigner"/>
              <meta name="keywords"
                    content="Harvest International School, HIS, Borg El-Arab, Borg Al-Arab, Egypt, مدارس هارفست, برج العرب, مدرسة, هارفست, Admission, Admission Process, Admission Requirements, Admissione Fees, مصاريف مدارس هارفست، متطلبات القبول، عملية القبول, Foreigner"/>
              ...
              divElements={[(
                  <div className="admission-requirements-note" key={1}>
                      <ul className={"admission-note-list"}>
                          ...
                          <li>
                              <p>
                                  The National and the International Departments request the same documents. However,
                                  students applying for the International department in upper stages should provide
                                  educational Sequence certificates stamped by the Egyptian Ministry of Foreign Affairs.
                              </p>
                          </li>

                          <li>
                              <p>
                                  After taking official acceptance from the student affairs department parents should
                                  fill (Returning Egypt Form) from the Egyptian Ministry of Foreign Affairs. This form
                                  requires 2 personal Photos and a certificate of the last stage the student passed
                              </p>
                          </li>

                          <li>
                              <p>
                                  Parents should provide recent passports and personal ID's for the students affairs department
                              </p>
                          </li>
