...
function EnglishDrama() {
  ...
  return (
    <div className={'students-life-library-books-page'}>
        ...
        <meta name="description" content="Learn more about the avialable books in the Drama category at the English library at Harvest International School in Borg El Arab, Egypt."/>
        ...
        <div className={"extreme-padding-container"}>
            ...
            <Form sendPdf={false} formKey={'library-book-request'} formTitle={t("students-life-pages.library-pages.suggest-book-form.student-book-recommendation-form")} fields={
                [
                    {
                        id: 1,
                        type: 'text',
