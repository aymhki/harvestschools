...
function ArabicReligion() {
  ...
  return (
      <div className={'students-life-library-books-page'}>
          ...
          <meta name="description" content="Learn more about the avialable books in the Religion category at the Arabic library at Harvest International School in Borg El Arab, Egypt."/>
          ...
          <div className={"extreme-padding-container"} >
              ...
              <LibraryBooksTable categoryKey={"arabic-religion"}/>
