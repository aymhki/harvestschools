...
const checkBookingSessionEndpoint = 'http://localhost:8080/scripts/checkBookingSession.php';
const getAllBookingsEndpoint = 'http://localhost:8080/scripts/getAllBookings.php';
const validateBookingLoginEndpoint = 'http://localhost:8080/scripts/validateBookingLogin.php';
const createBookingSessionEndpoint = 'http://localhost:8080/scripts/createBookingSession.php';
const deleteBookingEntryEndpoint = 'http://localhost:8080/scripts/deleteBookingEntry.php';
const submitAddBookingFormEndpoint = 'http://localhost:8080/scripts/submitAddBookingForm.php';
const getBookingInfoBySessionEndpoint = 'http://localhost:8080/scripts/getBookingBySession.php';
const submitEditBookingFormEndpoint = 'http://localhost:8080/scripts/submitEditBookingForm.php';

const createAdminSessionEndpoint = 'http://localhost:8080/scripts/createAdminSession.php';
const validateAdminSessionEndpoint = 'http://localhost:8080/scripts/checkAdminSession.php';
const validateAdminLoginEndpoint = 'http://localhost:8080/scripts/validateAdminLogin.php';
const getDashboardPermissionsEndpoint = 'http://localhost:8080/scripts/getDashboardPermissions.php';
const getUserPermissionsEndpoint = 'http://localhost:8080/scripts/getUserPermissions.php';
const submitFormEndpoint = 'http://localhost:8080/scripts/submitForm.php';

const submitJobApplicationEndpoint = 'http://localhost:8080/scripts/submitJobApplication.php';
const getJobApplicationsEndpoint = 'http://localhost:8080/scripts/getJobApplications.php';
