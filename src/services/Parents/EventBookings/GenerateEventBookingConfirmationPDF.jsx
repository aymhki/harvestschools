...
const generateEventBookingConfirmationPDF = async (action = 'download', setIsLoading, bookingId, bookingUsername, detailedData, setError) => {
    try {
        setIsLoading(true);
        ...
        try {
            ...
            const qrData = `${baseQRUrl}/events/event-booking-confirmation/?bookingId=${bookingId}&extrasId=${detailedData?.extras?.extra_id || ''}&authId=${detailedData?.booking?.password_hash || ''}&username=${bookingUsername}`;
...
export { generateEventBookingConfirmationPDF };
