...
try {
    ...
    $sessionSql = "SELECT auth_id, username FROM event_booking_sessions WHERE id = ?";
    ...
    $studentsSql = "SELECT 
                     s.*
                   FROM event_booking_students s
                   JOIN event_booking_students_linker sl ON s.student_id = sl.student_id
                   WHERE sl.booking_id = ?";
