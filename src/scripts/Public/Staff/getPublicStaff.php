...
if (!in_array($departmentKey, staff_department_keys(), true)) {
    ...
    echo json_encode(["success" => false, "message" => "Unknown department", "code" => 400]);
    exit;
}
...
try {
    ...
    if ($conn->connect_error) {
        ...
        echo json_encode(["success" => false, "message" => "Staff information is temporarily unavailable", "code" => 503]);
        exit;
    }
    ...
    echo json_encode(["success" => false, "message" => "Staff information is temporarily unavailable", "code" => 500]);
} finally {
