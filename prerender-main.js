...
const { render } = await import('./dist/prerender/entry-prerender-main.js');
...
const routesToPrerender = [
    ...
    '/academics/kindergarten-international',
    '/academics/kindergarten-national',
    ...
    '/events/kg-calendars',
    '/events/american-kg-calendar',
    '/events/british-kg-calendar',
    '/events/national-kg-calendar',
    '/gallery',
    '/gallery/photos',
    '/gallery/videos',
    '/gallery/360-tour',
