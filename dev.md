...
- [ ] Change the harvest in app browser icon from x to home icon in both iOS and android.
...
- [ ] Syncing locales is useless when assets are already synced in the deployment script, isn't it? or does the sha generated defer?
