...
- [ ] Add: Tables with action, edit or delete buttons should keep those columns sticky to the right by default, the same way the first column is sticky to the left, so only the columns in between scroll.
